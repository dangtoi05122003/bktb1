        ...
        <div class="booking-details">
            ...
            <div class="row">
                ...
                <select id="destination" name="destination" required onchange="updateTotalAmount()">
                    ...
                    <option value="America" data-price=" 28.5000.000">America</option>
                    <option value=">France" data-price="20.490.000">France</option>
                    <option value="Italy" data-price="25.490.000">Italy</option>
                    <option value="Japan" data-price="24.999.999">Japan</option>
                    <option value="England" data-price="27.490.000">England</option>
                    <option value="Thai Lan" data-price=" 7.000.000">Thai Lan</option>
                    <option value="Saudi Arabia" data-price="27.890.000">Saudi Arabia</option>
                    <option value="Canada" data-price="28.490.000">Canada</option>
                    <option value="Israel" data-price="34.490.000">Israel</option>
                    <option value="spain" data-price="30.490.000">spain</option>
                </select>
            </div>
