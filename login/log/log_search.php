...
if (isset($_GET['keyword'])) {
    ...
    switch ($name) {
        ...
        case "Spain":
            ...
            exit;
        case "Hà Nội":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_HaNoi.php");
            exit;
        case "Đà Lạt":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_DaLat.php");
            exit;
        case "Đà Nẵng":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_DaNang.php");
            exit;
        case "Hà Giang":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_HaGiang.php");
            exit;
        case "Hạ Long Bay":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_HaLongBay.php");
            exit;
        case "Huế":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_Hue.php");
            exit;
        case "Mỹ Tho":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_MyTho_CanTho.php");
            exit;
        case "Phú Quốc":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_PhuQuoc.php");
            exit;
        case "Sapa":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_Sapa.php");
            exit;
        case "TP Hồ Chí Minh":
            header("Location: http://localhost/BTKT/login/log/log_domestic/log_TPHoChiMinh.php");
            exit;
        default:
